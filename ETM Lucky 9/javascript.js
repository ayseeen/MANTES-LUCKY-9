...
document.getElementById('card1').innerHTML = "<img class='img-responsive img-fluid c1' src='img/"+suit[0]+rank[0]+".png'>";
var r1 = rank[0];
var suitIndex = Math.floor(Math.random() * suitsOuter.length)
var suit = [suitsOuter[suitIndex], suitsInner[suitIndex]];
var rankIndex = Math.floor(Math.random() * ranksOuter.length);
var rank = [ranksOuter[rankIndex], ranksInner[rankIndex]];
document.getElementById('card2').innerHTML = "<img class='img-responsive img-fluid c2' src='img/"+suit[0]+rank[0]+".png'>";
var r2 = rank[0];
if (r1=='j'||r1=='q'||r1=='k'){
      r1=0;
   }
...
function lucky(r1,r2){
   ...
   if (total == 9){
      ...
      document.getElementById('lucky9').innerHTML = "<h1 class='win'>You Win! You Got Lucky 9!</h1>";
   }
   else {
      document.getElementById('lucky9').innerHTML = "<h1 class='lose'>Try again.</h1>";
   }
}